...
;; [[file:config.org::*Diary functions][Diary functions:1]]
...
(cond
  ...
  ((string= theme-name "pink") (setq doom-theme 'doom-vibrant))
...
;; [[file:config.org::*Scoring][Scoring:2]]
(after! elfeed
...
(after! org
  ...
  ;; Detected missing LaTeX packages: adjustbox, cancel, capt-of, cleveref, embedall, fvextra, hanging, mathalpha, pdfx, svg, tcolorbox, Alegreya, arev, biolinum, FiraMono, FiraSans, fourier, gillius, kpfonts, libertine, newpxmath, newpxtext, newtxmath, newtxtext, newtxsf, noto, plex-mono, plex-sans, plex-serif, sourcecodepro, sourcesanspro, sourceserifpro
...
; This is a edit specifically for Jupyter
