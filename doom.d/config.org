...
Just enabling the journal, and making use of encryption, provided by org-crypt
...
By default reveal is rather nice, there are just some tweaks that I consider a
good idea.
...
When I want to paste exported markdown somewhere it can be preferable to have unicode characters for =---= etc. instead
of =&#x2014;=.
