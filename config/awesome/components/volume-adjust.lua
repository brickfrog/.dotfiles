...
local icon_dir = "/usr/share/icons/Papirus-Dark/24x24/panel/"
      ...
      awful.spawn.easy_async_with_shell(
         ...
         function(stdout)
            ...
            if (volume_level > 60) then
               volume_icon:set_image(icon_dir .. "volume-level-high.svg")
            elseif (volume_level > 0) then
               volume_icon:set_image(icon_dir .. "volume-level-low.svg")
            else
               volume_icon:set_image(icon_dir .. "volume-level-muted.svg")
            end
         end,
         false
      )
