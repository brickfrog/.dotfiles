...
_G.packer_plugins = {
  ...
  ["nvim-ts-context-commentstring"] = {
    loaded = true,
    path = "/home/justin/.local/share/nvim/site/pack/packer/start/nvim-ts-context-commentstring",
  ...
  ["surround.nvim"] = {
    ...
    loaded = true,
    path = "/home/justin/.local/share/nvim/site/pack/packer/start/surround.nvim",
